...
$(document).ready(function(){
    ...
    $(document).on('click touchstart', 'button[data-href]', function(){
    ...
    $(document).on('blur', '#procedure-form #Orders_link', function(){
            ...
            $.ajax({
                ...
                beforeSend: function(){
                    ...
                    $.each(_data, function(i, val) {
                        ...
                        $( '#procedure-form '+val ).removeAttr('readonly');
                    });
        ...
        {
            $.each(_data, function(i, val) {
                $( '#procedure-form '+val ).val('').removeAttr('readonly');
            });
    ...
    $(document).on('keyup', '#procedure-form #Orders_price', function(){
        ...
        var _v = ( typeof _pOne != 'undefined' ) ? parseFloat( _pOne ) : parseFloat( _this.val() );

        if( _v != '' && $.isNumeric(_v) )
        {
            var totalVal = ( _v * ( parseFloat( _p ) / 100 ) ) + _v;
        
            _t.val( ( totalVal * _c ).toFixed(2) ).attr('readonly','readonly');
        }
        else
        {
            _t.val( '' ).removeAttr('readonly');
        }
    });

    $(document).on('click touchstart', '#addNewLink', function(){
        var _this = $(this);
    ...
    $(document).on('click touchstart', '.go2Order', function(){
        var _this = $(this);
        var _form = _this.closest('form');
    ...
    $(document).on('click touchstart', '.link-thumbnail[data-do], button[data-do]', function(){
        var _this = $(this);
    ...
    $(document).on('click touchstart', '.inputs-wrapper--shopping button[data-url]', function(){
        var _this = $(this)
    ...
    $(document).on('click touchstart', 'button.orders-tab__button[data-type]', function(){
        var _this = $(this);
    ...
    $(document).on('click touchstart', '.createOrderModal', function(){
        var _this = $(this);
    ...
    $(document).on('click touchstart', '.order-pager li a', function(){
        var _this = $(this);
    ...
    $(document).on('click touchstart', '.news-pager li a', function(){
        var _this = $(this);
        $.ajax({
            type: 'POST',
            data: 'ajax=click',
    ...
    $(document).on('click touchstart', '.showTracking, .receivingPerson', function(){
        var _this = $(this);
    ...
    $(document).on('click touchstart', '.addBalanceButton[data-url]', function(){
       var _this = $(this);
    ...
    $(document).on('click touchstart', '.payment-radiogroup-row label', function(){
        var _this = $(this);
    ...
    $(document).on('click touchstart', '.close-additional-item', function(){
    ...
    $(document).on('click touchstart', 'button[data-repeat-target="item"]', function(){
        var _items = $('[data-repeat-id="item"]');
    ...
    $(document).on('click touchstart', '.calculateButton', function(e) {
        var _this = $(this);
    ...
    $(document).on('click touchstart', '.fag-data', function(e) {
       var _this = $(this);
    ...
    $(document).on('click touchstart', '.orderPaymentCheckbox', function(e) {
        var _this = $(this);
        var _b = $('.pay-button');
    ...
    $(document).on('click touchstart', '.og-pay', function(e) {
        var _this = $(this);
        var _b = $('.og-total-pay');
    ...
    $(document).on('click touchstart', '.og-total-pay', function(e) {
        var _this = $(this);
    ...
    $(document).on('click touchstart', '.pay-button', function(e) {
        var _this = $(this);
    ...
    $(document).on('click touchstart', '.add2balance', function(e) {
        var _this = $(this);
    ...
    $(document).on('change', '#OrdersGroups_link_id', function(e) {
        var _this = $(this);
        if( _this.val() != '' )
            $('#OrdersGroups_name').val( _this.find('option:selected').html() );
        else
            $('#OrdersGroups_name').val( '' );
    });*/
    
    $(document).on('click touchstart', '.verificationButton', function(e) {
        var _this = $(this);
    ...
    $(document).on('click touchstart', '.delete-og-button', function(){
        var _this = $(this);
